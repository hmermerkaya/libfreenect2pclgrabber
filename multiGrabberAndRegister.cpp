...
*/
     ...
     viewer->addPointCloud<pcl::PointXYZRGB>(source, pcl::visualization::PointCloudColorHandlerRGBField<pcl::PointXYZRGB>(source), "source");

     viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "source");

   viewer->addPointCloud<pcl::PointXYZRGB>(target, pcl::visualization::PointCloudColorHandlerRGBField<pcl::PointXYZRGB>(target), "target");
 ...
 // viewer->registerKeyboardCallback(KeyboardEventOccurred, (void*)&ps);
  ...
  while(!viewer->wasStopped()){
   ...
   // std::cout << "delta " << std::chrono::duration_cast<std::chrono::duration<float>>(tpost - tnow).count() * 1000 << std::endl;
    ...
    //for(size_t i = 0; i < kinect2_count; ++i)
      viewer->updatePointCloud<pcl::PointXYZRGB>(source, pcl::visualization::PointCloudColorHandlerRGBField<pcl::PointXYZRGB> (source), "source");
  
     viewer->updatePointCloud<pcl::PointXYZRGB>(target, pcl::visualization::PointCloudColorHandlerRGBField<pcl::PointXYZRGB> (target), "target");
