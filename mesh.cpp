...
readTransformFromText("output_0.calibtranstext", calib0);
calibs.push_back(calib0);

Eigen::Matrix4f calib1;
readTransformFromText("output_1.calibtranstext", calib1);
calibs.push_back(calib1);

Eigen::Matrix4f calib2;
readTransformFromText("output_2.calibtranstext", calib2);
...
GlobalCalibratedTransforms.push_back(calibs.at(0));
GlobalCalibratedTransforms.push_back(trans.at(0)*calibs.at(1));
GlobalCalibratedTransforms.push_back(trans.at(1)*calibs.at(2));
...
sz = GlobalCalibratedTransforms.size();
if (sz>0) {
 ...
 std::vector<Eigen::Matrix4f> GlobalCalibTransforms;
